...
public class Main {
    ...
    public static void compress(String filename) throws IOException {
        ...
        byte[] comp = Deflate.compress(rawData); //, progress -> System.out.print((progress >= 100 ? "\n" : "\r") + "C: " + progress));
        byte[] decomp = Deflate.decompress(comp); //, progress -> System.out.print((progress >= 100 ? "\n" : "\r") + "D: " + progress));
        System.out.println("\n LZ77 nzip (" + filename + ") -> C: " + comp.length + " | D: " + decomp.length + " | R: " + rawData.length + " | Verify: " + Arrays.equals(rawData, decomp));
    }
